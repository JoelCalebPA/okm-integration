...
import com.domain.config.auth.CustomAuthenticationProvider;
import com.domain.config.auth.CustomLoginSuccessHandler;
import com.domain.config.auth.CustomLogoutSuccessHandler;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.authorizeRequests()
				...
				.antMatchers("/feature/**").access("hasRole('ADMIN')")
